...
void UAwAction::OnRep_RepData()
{
	// TODO: Fix the nullptr
...
UAwAction::UAwAction()
{
	RepData = FAwActionRepData(false, nullptr);
	InitAtt();
...
inline void UAwAction::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	UObject::GetLifetimeReplicatedProps(OutLifetimeProps);
	DOREPLIFETIME(UAwAction, RepData);
}